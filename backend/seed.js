...
const seed = async () => {
  ...
  const visits = await Visit.insertMany([
    { patientId: patients[0]._id, doctorId: doctors[1]._id, visitDate: '2025-09-28', followUpDate: '2025-10-12', notes: 'Routine check-up was all clear. Recommended to continue current diet and exercise plan.' },
